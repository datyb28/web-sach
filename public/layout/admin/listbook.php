...
<body>
		...
		<aside class="col-md-2">
			...
			<div id='cssmenu'>
				<ul>
					...
					<li class='has-sub'><a href='#'><span><i class="glyphicon glyphicon-th-large"></i> Slider</span></a>
						<ul>
							<li><a href='#'><span>Thêm slider</span></a></li>
							<li class='last'><a href='#'><span>Quản lý slider</span></a></li>
						</ul>
					</li>
					<li><a href='#'><span><i class="glyphicon glyphicon-comment"></i> Quảng cáo</span></a></li>
					<li><a href='#'><span><i class="glyphicon glyphicon-cog"></i> Thông tin</span></a></li>
	...
	<section class="content-right">
		...
		<section class="col-md-10 ct-right">
			<ol class="breadcrumb">
				<li>Sách</li>
				<li class="active">Danh mục sách</li>
			</ol>
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						<table class="table table-hover table-bordered">
							...
							<tbody>
								<tr>
									<td>1</td>
									<td>Sách tiếng Việt tập 1</td>
									<td>12.500đ</td>
									<td><img src="../public/images/san_pham/sach_giao_khoa/lop_1/tiengviet_tap1.jpg" alt="" class="img-responsive img-img"></td>
									<td>121</td>
									<td>Giáo dục</td>
									<td>Nhiều tác giả</td>
									<td>Sách giáo khoa</td>
									<td><a href="" title="Xem chi tiết"><span class="
glyphicon glyphicon-eye-open"></span></a> <a href="" title="Sửa sản phẩm"> <span class="
glyphicon glyphicon-pencil"></span></a> <a href="" title="Xóa sản phẩm"> <span class="
